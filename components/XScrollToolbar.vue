...
<template>
  <div class="hidden toolbar fixed md:flex flex-col space-y-2 " style="bottom:10%;right:calc(50% - 290px);z-index: 999;">
    <div
      class="group bg-white dark:bg-gray-900 rounded px-2 py-1 cursor-pointer shadow-10px" :class="[y > 100 ? 'visible' : 'invisible']"
      @click="y = 0"
    >
    ...
    <div
      class="group bg-white dark:bg-gray-900 rounded px-2 py-1 cursor-pointer shadow-10px " :class="[showToBottom ? 'visible' : 'invisible']"
