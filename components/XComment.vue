    ...
    <div class="flex-1 space-y-2">
      <div class="flex space-x-4 text-xs mt-1 text-gray-500">
        ...
        <div class="flex items-center space-x-1 text-primary/40">
          ...
          <span>{{ dateFormatAgo(updatedAt) }}</span>
        </div>
        ...
        <div v-if="token && userinfo && userinfo.uid !== props.author.uid" class="flex gap-.5 items-center space-x-1 hover:text-primary/80 cursor-pointer" @click="quoted">
